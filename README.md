...
<p>
Next we are using the customer Karen to create a SEV-A ticket. For this example the help topic is business critical outage and the issue is the entire mobile banking system is down.
</p>
<br />
